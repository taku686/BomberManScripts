...
public class PlayerRyofu_OffLine : PlayerBase_OffLine
{
    ...
    IEnumerator Meteorite()
    {
        ...
        {
            GameObject bombClone = BombManager.Instance.BombInstantiate(new Vector3(targetPos.x + 2, 8, targetPos.z), bombId++, actorNum, BombType(), itemManager.firePower,GManager.Instance.playerNum);//, itemManager.isKick);
